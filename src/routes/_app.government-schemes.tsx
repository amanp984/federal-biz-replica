...
export const Route = createFileRoute("/_app/government-schemes")({
  head: () => ({ meta: [{ title: "Government Schemes — FED BIZ" }] }),
  component: () => (
    <div className="space-y-5">
      ...
      <div className="bg-white border rounded-md p-12 text-center">
        ...
        <div className="text-sm text-muted-foreground mt-1">Please contact your branch for active government schemes.</div>
      </div>
    </div>
  ),
});